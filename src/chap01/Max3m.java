...
public class Max3m {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("max3(3,2,2) = " + max3(2, 2, 3));
        System.out.println("max3(3,2,2) = " + max3(2, 3, 1));
        System.out.println("max3(3,2,2) = " + max3(2, 3, 2));
        System.out.println("max3(3,2,2) = " + max3(1, 3, 2));
        System.out.println("max3(3,2,2) = " + max3(2, 3, 3));
        System.out.println("max3(3,2,2) = " + max3(1, 2, 3));
    }
}
